...
export const HomePageData: HomePageType = {
  ...
  },
  {
    "nameRO": "Consultanta",
    "nameEN": "Consultation",
    "descriptionRO": "Putem avea o discutie despre ce iti doresti, personalizand tatajul si sa decidem pretul pentru el",
    "descriptionEN": "We can have a conversation about what you want, personalize the tattoo, and decide on the price together."
  }
]
};